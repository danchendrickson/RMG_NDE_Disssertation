...
class mpu6050:
    ...
    #X_OFFSET = 0.08724488896
    #Y_OFFSET = -0.00723823276
    #Z_OFFSET = 0.02943127075

    def __init__(self, address, bus=1, X_OFFSET = 0, Y_OFFSET =0, Z_OFFSET=0):
    ...
    def get_temp(self):
        ...
        actual_temp = ((raw_temp / 340.0) + 36.53 * (9/5) +32)
    ...
    def get_accel_data(self, g = False):
        ...
        x = float(int((x / accel_scale_modifier - self.X_OFFSET)*100000.0))/100000.0
