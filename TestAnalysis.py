...
def PlotFingerPrint(data, xName='a', title='', FP='mexh',scales = 500, slices=10, trim=0):
...
for Filename in files:
    if Filename[-4:] ==  '.csv':
        ...
        for i in range(1):
            ...
            PlotFingerPrint(SmoothXDataSet[:,i],'a',title,'coif1')
...
FpScat=fp.getLabeledThumbprint(SmoothXDataSet[:,i], 'db2',scales,slices)
...
anim.save(location+'animation.gif')
